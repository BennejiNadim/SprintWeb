...
class LivraisonController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $livraisons = $em->getRepository('VenteBundle:Livraison')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('VenteBundle\Form\LivraisonType', $livraison);
    ...
    {
        $deleteForm = $this->createDeleteForm($livraison);
        $editForm = $this->createForm('VenteBundle\Form\LivraisonType', $livraison);
